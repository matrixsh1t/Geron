...
var newList = employees.filter(function (item) {
    return item.isActive;
});
console.log(newList);
var salaryIncrease = function (list) {
    var increasedSalaryList = [];
    for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
        var employee = list_1[_i];
        if (employee.age < 20) {
...
console.log(salaryIncrease(newList).sort(function (a, b) {
    return a.age - b.age;
}));
